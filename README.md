# 🚀 Jornada de Dados: Do Zero ao Sênior
...
## 📌 Sobre o Repositório
Este é o repositório central da minha formação em **Engenharia de Dados e Analytics**. 

O objetivo deste projeto é documentar minha evolução técnica, saindo dos fundamentos de lógica de programação até a construção de pipelines de dados complexos, Data Lakes e Arquiteturas em Nuvem. Todo o código segue boas práticas de mercado (Clean Code, Versionamento e Estruturação).
